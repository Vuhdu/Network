...
namespace CommonUtilities
{
	...
	public:
		...
		// The frame the user pressed the button.
		bool IsKeyDown(const eKeyCode aKeyCode);
		// The frame the user pressed the button.
		bool IsKeyDown(const eMouseButton aMouseButton);

		// The frame the user released the button.
		bool IsKeyUp(const int aKeyCode);
		// The frame the user released the button.
		bool IsKeyUp(const eKeyCode aKeyCode);
		// The frame the user released the button.
		bool IsKeyUp(const eMouseButton aMouseButton);

		// The frames the user is pressing the button.
		bool IsKeyPressed(const int aKeyCode) const;
		// The frames the user is pressing the button.
		bool IsKeyPressed(const eKeyCode aKeyCode) const;
		// The frames the user is pressing the button.
		bool IsKeyPressed(const eMouseButton aMouseButton) const;
